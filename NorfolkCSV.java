package sim.app.geo.norfolk_csv;
 ...
 *
 */
public class NorfolkCSV extends SimState	{
	/////////////// Model Parameters ///////////////////////////////////
    ...
    public NorfolkCSV(long seed)	{
        ...
        try	{
            ...
            URL lsoaGeometry = NorfolkCSV.class.getResource("data/NorfolkLSOA.shp");
            ...
            URL floodGeometry = NorfolkCSV.class.getResource("data/flood_zone_3_010k_NORFOLK_ONLY.shp");
            ShapeFileImporter.read(floodGeometry, flood);
            MBR.expandToInclude(flood.getMBR());
            
        	System.out.println("Reading Road Network layer...");
            URL roadGeometry = NorfolkCSV.class.getResource("data/NorfolkITN.shp");
            ...
            Logger.getLogger(NorfolkCSV.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
