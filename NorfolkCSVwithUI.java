 ...
 * @author KJGarbutt
 */
public class NorfolkCSVwithUI extends GUIState	{
    ...
    /** Default constructor */
    public NorfolkCSVwithUI(SimState state)	{
        super(state);
    }

    public NorfolkCSVwithUI() throws ParseException	{
        super(new NorfolkCSV(System.currentTimeMillis()));
    }
    ...
    public void init(Controller controller)	{
        ...
        display = new Display2D(NorfolkCSV.WIDTH, NorfolkCSV.HEIGHT, this);
    ...
    public static void main(String[] args)	{
        NorfolkCSVwithUI worldGUI = null;

        try	{
            worldGUI = new NorfolkCSVwithUI();
        }
        catch (ParseException ex)	{
            Logger.getLogger(NorfolkCSVwithUI.class.getName()).log(Level.SEVERE, null, ex);
        }
