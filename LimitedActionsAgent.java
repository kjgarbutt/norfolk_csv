...
public class LimitedActionsAgent implements Steppable {
	 ...
	 * 
	 */
    public LimitedActionsAgent(NorfolkCSV state)	{
    ...
    private void findNewPath(NorfolkCSV geoTest)    {
    ...
    public void step(SimState state)    {
    	NorfolkCSV campState = (NorfolkCSV) state;
        move(campState);
     ...
     */
    private void move(NorfolkCSV geoTest)    {
